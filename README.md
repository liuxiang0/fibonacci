...
- 快速求前n项之和 $F_1+F_2+...+F_n=F_{n+2}-1$（跳2减1）
- 奇数项之和 $F_1+F_3+...+F_{2n-1}=F_{2n}$（奇和偶下标）
- 偶数项之和 $F_2+F_4+...+F_{2n} = F_{2n+1}-1$ （偶和奇下标减1）
- 交替之和 $F_1-F_2+F_3-F_4+...+(-1)^{n+1}F_{n} = (-1)^{n+1}F_{n-1}+1$
- 平方和 $F_1^2+F_2^2+...+F_n^2 = F_n\cdot F_{n+1}$（平方和尾乘）
- 下标和 $F_{n+m} = F_{n-1}\cdot F_{m} + F_{n} \cdot F_{m+1}$
- 平方差公式 $F_{n+1}^2-F_{n-1}^2 = F_{2n}$
